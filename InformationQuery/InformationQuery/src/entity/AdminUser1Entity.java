...
/**
 * The persistent class for the admin_user1 database table.
 * 
 */
@Entity
@Table(name="admin_user1")
public class AdminUser1Entity implements Serializable {
	private static final long serialVersionUID = 1L;
	private AdminUser1EntityPK id;
    ...
    public AdminUser1Entity() {
    }


	@EmbeddedId
	public AdminUser1EntityPK getId() {
		return this.id;
	}

	public void setId(AdminUser1EntityPK id) {
		this.id = id;
	}
